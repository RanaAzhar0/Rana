        ...
        <Swiper
          ...
          <SwiperSlide className="">
            <div className="h-[80vh] w-72 ">
              ...
              <div className="h-8 w-[100%]  flex  justify-center items-center ">
                <p className="font-thin text-sm text-black ">Chardonnay, Mitroi Domains</p>

              </div>
              <div className="h-16 w-[100%]  flex flex-col justify-center items-center  ">
                <p className="font-bold  text-sm  text-black hover:hidden cursor-pointer">Rs 7500</p>
          ...
          <SwiperSlide>
            <div className="h-[80vh] w-72  ">
              ...
              <div className="h-16 w-[100%]  flex flex-col justify-center items-center  ">
                <p className="font-bold  text-sm   hover:hidden cursor-pointer text-black">Rs 1500</p>
                <button className="hover:text-green-700 text-lg font-extrabold cursor-pointer ">Add cart</button>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="h-[80vh] w-72  ">
              ...
              <div className="h-16 w-[100%]  flex flex-col justify-center items-center  ">
                <p className="font-bold  text-sm   hover:hidden cursor-pointer text-black">Rs 5000</p>
                <button className="hover:text-green-700 text-lg font-extrabold cursor-pointer ">Add cart</button>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="h-[80vh] w-72  ">
              ...
              <div className="h-16 w-[100%]  flex flex-col justify-center items-center  ">
                <p className="font-bold  text-sm   hover:hidden cursor-pointer  text-black">Rs 1000</p>
                <button className="hover:text-green-700 text-lg font-extrabold cursor-pointer ">Add cart</button>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="h-[80vh] w-72  ">
              ...
              <div className="h-16 w-[100%]  flex flex-col justify-center items-center  ">
                <p className="font-bold  text-sm   hover:hidden cursor-pointer  text-black">Rs 8500</p>
                <button className="hover:text-green-700 text-lg font-extrabold cursor-pointer ">Add cart</button>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="h-[80vh] w-72  ">
              ...
              <div className="h-16 w-[100%]  flex flex-col justify-center items-center  ">
                <p className="font-bold  text-sm   hover:hidden cursor-pointer  text-black">Rs 9000</p>
                <button className="hover:text-green-700 text-lg font-extrabold cursor-pointer ">Add cart</button>
              </div>
            </div>
          </SwiperSlide>
