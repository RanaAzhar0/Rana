  ...
  return (
    <>
      ...
      <div className='h-[90vh] w-[100%] bg-yellow-400 p-1'>
        <h1 className='text-4xl font-extrabold text-black font-[oswald] mt-11 ml-[78vh]'>WHY SUBSCRIBE?</h1>
        <div className=' h-[65vh] w-[100%] flex items-center justify-around mt-11' >
          <div className='h-[55vh] w-[30%] flex flex-col justify-between items-center'>
            ...
            <div className='h-24 w-[100%]   flex justify-center items-center'>
              <p className='font-bold  text-black'>You receive carefully chosen wines, by sommelie<br />rs and hobbyists, from wine cellars who love<br /> grapes and wine, equally.</p>
            </div>
          </div>
