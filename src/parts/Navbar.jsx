            ...
            <div className={colorChange ? 'navbar colorChange h-16  w-[100%] flex  duration-200 flex-row justify-around  z-50 top-0 sticky' : 'navbar h-16  w-[100%] flex flex-row justify-around z-50 top-0 absolute duration-200'}>
                ...
                <div className='flex  flex-row w-64 mr-[35vh] justify-between'>
                    ...
                    <ul className="flex  justify-between items-center w-[100%]">
                        <h1 className='text-black cursor-pointer font-[oswald] text-lg font-bold hover:text-slate-400 hover:duration-700 mt-1'>SUBCRIPTIONS</h1>
                        <li className='text-black cursor-pointer font-[oswald] text-sm font-semibold hover:text-slate-400 hover:duration-700 font-'>SHOP


                        </li>
                        <li className='text-black cursor-pointer  font-[oswald] text-sm font-semibold hover:text-slate-400 hover:duration-700'>GIFTS</li>
